...
\begin{longtable}[]{@{}ll@{}}
\toprule
社区 & Steemcoinpan\tabularnewline
\midrule
\endhead
Token & SCT\tabularnewline
网站 & \href{https://www.steemcoinpan.com}{link}\tabularnewline
标签 & sct\tabularnewline
结算时间（天） & 3\tabularnewline
点赞时间（天） & 2\tabularnewline
取消锁仓时间（天） & 3\tabularnewline
取消代理时间（天） & 3\tabularnewline
作者/审查收益比 & 45\% / 45\%\tabularnewline
作者收益曲线 & 1.3\tabularnewline
点赞收益曲线 & 0.9\tabularnewline
\bottomrule
\end{longtable}
